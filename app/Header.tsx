...
export default function Header() {
  ...
  return (
    <nav style={{ background: "#fff", borderBottom: "1px solid #ebebeb", padding: "0 40px", height: 64, display: "flex", alignItems: "center", justifyContent: "space-between", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <a href="https://tally.so/r/0Qolz6" target="_blank" rel="noopener noreferrer" style={{ background: "#a8d8b0", color: "#fff", borderRadius: 8, padding: "10px 20px", fontSize: 13, fontWeight: 700, textDecoration: "none" }}>
        Demander une demo
      </a>
    </nav>
  );
